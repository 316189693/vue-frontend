<template>
    ...
    <div class="grid-100 tablet-grid-100 container manifest-line-container">
        ...
        <div class="grid-100 tablet-grid-100 container schedule-pickup-hidden margin-top-20" v-if="requireDescription">
            <span class="manifest-line-count">{{index + 1}}</span>
            <div class="grid-20 tablet-grid-60 margin-top margin-left">
        ...
        <div class="grid-parent grid-100 tablet-grid-100 container line-details">
            <div class="grid-20 tablet-row-1 tablet-grid-100" style="padding-right:0px;">
                <div class="grid-100 tablet-grid-60 padding-right">
                ...
                <div class="hidden tablet-grid-100 container"></div>
            </div>

            <div class="grid-30 tablet-grid-100 tablet-row-2">
            ...
            <div class="grid-30 tablet-row-3 tablet-grid-100 container">
                <div class="grid-30 tablet-grid-33 remove-padding-left">
                ...
                <div class="grid-30 tablet-grid-33 padding-adjustments">
                ...
                <div class="grid-25 tablet-grid-33 padding-adjustments">
            ...
            <div class="tablet-row-4 tablet-grid-100">
                ...
                <span class="manifest-tooltip-light stackable-tooltip" v-tooltip.bottom="tooltipMessages.stackable"></span>
            </div>
