<template>
	<div class="grid-container get-quote-container">
		<div class="grid-100 tablet-grid-80">
			<div class="grid-parent grid-100 tablet-grid-80 container">
				<h1 class="title margin-left-10">{{pageTitle}}</h1>
			</div>

			<div class="grid-parent grid-50 tablet-grid-80 container step-container add-margin-bottom">
				<div class="grid-parent grid-100 tablet-grid-100 container margin-left-10">
				...
				<div class="grid-parent grid-50 tablet-grid-50">
				...
				<div class="grid-50 tablet-grid-50">
					<div class="grid-100 tablet-grid-100 container step-container nowrap">
			...
			<div class="grid-50 tablet-grid-80 container add-margin-bottom">
				<div class="grid-100 tablet-grid-100 container step-container">
					<h1 class="step-header">
						<span class="label-number active">2</span>Where are we delivering?
					</h1>
				</div>
				...
				<div class="grid-50 tablet-grid-50">
					<div class="grid-100 tablet-grid-100 container nowrap">
						<h1 class="section-header optional-label">Additional Information</h1>
					</div>
			...
			<div class="grid-100 tablet-grid-80 container padding-top">
				<div class="grid-100 tablet-grid-100 container">
					<h1 class="step-header">
						...
						<label class="checkbox tablet-checkbox" for="hazard_material">
							<span>My shipment(s) contain <span id="break-word"> Hazardous Material</span>
				...
				<div class="grid-100 tablet-grid-100 container" v-if="!(quoteData.hasQuote || calculating)">
					<div class="grid-15 tablet-grid-30 margin-left-button">
		...
		<div class="grid-100 tablet-grid-80 container footer">
			<div class="grid-100 tablet-grid-100 container">
		...
		<OneButtonModal :modalName="errorNoCreditModal" :title="errorNoCreditModalTitle" :showXBtn="showXBtn" :width="errorWidth" @btnAction="closeNoCreditErrorModal">
            <slot>
                <p>Waiting for the credit limit approval to be approved, please contact 
                    <a href="mailto:ship@unisco.com">ship@unisco.com</a> with your order details.
                </p>
            </slot>
        </OneButtonModal>

        <OneButtonModal :modalName="errorOverCreditModal" :title="errorOverCreditModalTitle" :showXBtn="showXBtn" :width="errorWidth" @btnAction="closeOverCreditErrorModal">
            <slot>
                <p>Your order is over your credit limit and may not be scheduled at this time.</p>
            </slot>
        </OneButtonModal>
...
<style lang="scss" src="./getQuote.scss" scoped></style>
